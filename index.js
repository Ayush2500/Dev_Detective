...
function enableLightMode(){
    root.setProperty("--lm-big", "#F6F8FF");
...
// This code check if the user's device has a preference of dark mode
const prefersDarkMode = window.matchMedia && window.matchMedia("(prefers-color-scheme: dark)").matches;

// Check if there is a value for dark-mode in the user localStorage
if(localStorage.getItem("dark-mode") === null){
    ...
    // If there is a value for dark mode in localStorage, use that value
